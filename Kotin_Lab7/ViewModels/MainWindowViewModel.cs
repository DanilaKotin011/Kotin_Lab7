...
using Kotin_Lab7.Models;
using Avalonia.Media;

namespace Kotin_Lab7.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<Note> BuildAllNotes()
        {
            ...
            {
                new Note("Котин Данила Сергеевич","2","1","2","0","1","1","2",false),
                new Note("Картофель Сергей Сергеич","1","1","1","1","1","1","1",false),
                new Note("Таран Баран Кабан","2","0","0","0","2","0","0",false),
            };
        }
